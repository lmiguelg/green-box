...
app.post('/posts', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var post, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
app.patch('/posts/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var post, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
app.get('/users/:id/posts', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var posts, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
